...
func CreateFunctionRequirementsForControllers(clientUrl string, walletAbiName string, contractAddress string, privateKey string) (error, *ethclient.Client, common.Address, *bind.TransactOpts) {
